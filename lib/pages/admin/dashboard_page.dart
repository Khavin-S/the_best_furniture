      ...
      child: Column(
        children: [
          ...
          child: Row(
            ...
            children: [
               Text(currentContentText, style: MyTextStyle.subtitleStyle),
                      ...
                      child: ListTile(
                        ...
                        title: Row(
                          ...
                          children: [
                            ...
                            Expanded(child: Text(product.category, style: MyTextStyle.bodyStyle)),
                            Expanded(
                        ...
                        trailing: PopupMenuButton<String>(
                          ...
                          itemBuilder: (BuildContext context) {
                            return <PopupMenuEntry<String>>[
                              PopupMenuItem(
                                onTap: () {
                                  Navigation.goto(context, UpdateProductPage());
                                },
                                value: 'Option 1',
                                child: const Text(
                                  "Update product",
